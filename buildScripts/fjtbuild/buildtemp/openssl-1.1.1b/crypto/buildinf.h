...
#define DATE "built on: Tue May 14 08:00:04 2019 UTC"
...
static const char compiler_flags[] = {
    ...
    'N','T',' ','-','D','Z','L','I','B',' ','-','I','/','U','s','e',
    'r','s','/','z','h','e','n','g','x','i','a','n','g','y','a','n',
    'g','/','w','o','r','k','/','f','j','t','/','f','j','t','_','x',
    'p','/','b','u','i','l','d','S','c','r','i','p','t','s','/','f',
    'j','t','b','u','i','l','d','/','b','u','i','l','d','t','e','m',
    'p','/','f','j','t','v','3','s','s','l','/','z','l','i','b','-',
    '1','.','2','.','1','1','/','i','n','c','l','u','d','e','\0'
};
