...
shared =  mod_fjt.la
export MOD_CFLAGS = -std=c99  -I$(FJT_HOME)/openssl-1.1.1b/include -Wno-error=declaration-after-statement
export MOD_LDFLAGS = -L$(FJT_HOME)/openssl-1.1.1b/lib -lssl -lcrypto -lpthread
